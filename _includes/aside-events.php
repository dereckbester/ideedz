...
<h2>Schedule</h2>
<p>There's a lot happening. Make that you don't miss out on the fun. Be sure to check out the <a href="schedule.php">event listings</a>.</p>
	...
	<section class="accordion-group">
		...
		<div id="monday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="events.php#monday" class="btn btn-danger btn-small">Monday's Schedule</a></p>
	...
	<section class="accordion-group">
		...
		<div id="tuesday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="events.php#tuesday" class="btn btn-danger btn-small">Tuesday's Schedule</a></p>
	    </section><!-- accordion-inner -->
	  </div><!-- accordion-body -->
	</section><!-- accordion-group -->
	...
	<section class="accordion-group">
		...
		<div id="wednesday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="events.php#wednesday" class="btn btn-danger btn-small">Wednesday's Schedule</a></p>
	    </section><!-- accordion-inner -->
	  </div><!-- accordion-body -->
	</section><!-- accordion-group -->
	...
	<section class="accordion-group">
		...
		<div id="thursday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="events.php#thursday" class="btn btn-danger btn-small">Thursday's Schedule</a></p>
	    </section><!-- accordion-inner -->
	  </div><!-- accordion-body -->
	</section><!-- accordion-group -->
	...
	<section class="accordion-group">
		...
		<div id="friday" class="accordion-body collapse">
			<section class="accordion-inner">
				...
				<p><a href="events.php#friday" class="btn btn-danger btn-small">Friday's Schedule</a></p>
	    </section><!-- accordion-inner -->
	  </div><!-- accordion-body -->
	</section><!-- accordion-group -->
